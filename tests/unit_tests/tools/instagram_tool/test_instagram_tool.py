...
from chatdevagi.tools.instagram_tool.instagram import InstagramTool # Replace 'your_file' with actual file name that contains this class
import requests
...
class TestInstagramTool(unittest.TestCase):
    ...
    @patch("chatdevagi.helper.resource_helper.ResourceHelper")
    ...
    @patch("chatdevagi.helper.s3_helper.S3Helper")
